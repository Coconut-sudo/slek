...
function renderTimetable(electiveCourses, studentId) {
    ...
    let ppt = "<b>程式講座</b><br>(教室 B)";
    let ppt2 = "<b>程式講座</b><br>(教室 B)";
    ...
    electiveCourses.forEach((row) => {
        ...
        if (studentIdInSheet === studentId) {
            for (let i = 1; i < row.length; i++) {
                ...
                if (course && course.includes("面試講座")) {
                    interview = "<b>面試講座</b><br>(教室 A)";
                    }
                ...
                if (course && course.includes("簡報製作課")) {
                    ppt = "<b>簡報製作課</b><br>(教室 A)";
                    ppt2 = "<b>簡報製作課</b><br>(教室 A)";
                } 
